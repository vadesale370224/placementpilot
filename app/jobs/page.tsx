      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-8 space-y-8 animate-fadeIn">
          ...
          <div className="max-w-4xl space-y-6">
            {matches.length === 0 ? (
              <p className="text-center py-12 text-gray-505">{t("noMatches")}</p>
            ) : (
              matches.map((match) => (
                <div
                  key={match.job.id}
                    ...
                    <button
                      ...
                      className={`px-6 py-2.5 rounded-xl font-extrabold text-xs shadow-md transition duration-200 cursor-pointer ${
                        match.isApplied
                          ...
                          : "bg-gradient-to-r from-violet-600 via-blue-600 to-cyan-500 hover:from-violet-700 hover:to-cyan-600 text-white hover:scale-[1.03] active:scale-[0.97]"
                      }`}
                    >
